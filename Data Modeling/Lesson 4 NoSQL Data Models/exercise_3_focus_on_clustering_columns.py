...
# 1 Quetion of the data... 
# Give me all the information from music library about a given album
'select * from album_library WHERE album_name="Close To You"'

# How should we model the data? What should be our Primary Key and Partition Key?
# album_name and artist_name should be enough to make the row key unique!!

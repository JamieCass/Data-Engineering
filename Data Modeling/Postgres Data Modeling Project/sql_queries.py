...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id int, start_time numeric,
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS time (start_time numeric, hour int,
